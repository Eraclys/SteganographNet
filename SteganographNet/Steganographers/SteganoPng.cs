...
namespace SteganographNet.Steganographers
{
    ...
    {
        static readonly ISteganographer<Image<Rgba32>> DefaultStrategy = ImageRgba32Steganographer.Default;
        ...
        public Task Save(Stream outputStream)
        {
            return Value.SaveAsPngAsync(outputStream, Encoder);
        }
    }
}
